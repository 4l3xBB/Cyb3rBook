...
> [!INFO]-
>
> Note that, in order to disable *Kerberos Pre-Auth* for a Domain User Account, the ***[DONT_REQ_PREAUTH](https://learn.microsoft.com/en-us/troubleshoot/windows-server/active-directory/useraccountcontrol-manipulate-account-properties)***  flag must be enabled in the User Account Properties
>
...
> ***[Reference](https://github.com/fortra/impacket/blob/master/examples/GetNPUsers.py)***
...
```bash
GetNPUsers.py -dc-ip <TARGET> <DOMAIN>/ -usersfile <FILE> -outputfile <FILE>
```
...
> [!INFO]-
>
> A *NTLMv1 Hash* is generated from apply a MD4 digest function to a plain password of a user account, either local or domain
>
...
> [!INFO]-
>
> The *SPN or Service Principal Name* is an unique identifier of an available service in the domains. This service is associated to a *Domain Computer or User Account*
>
...
> ***[Reference](https://github.com/fortra/impacket/blob/master/examples/GetUserSPNs.py)***
...
To ensure that the *AS* and the *TGS* issue tickets with a solid cypher, proceed as indicated ***[here](https://www.stigviewer.com/stig/windows_10/2017-04-28/finding/V-63795)***