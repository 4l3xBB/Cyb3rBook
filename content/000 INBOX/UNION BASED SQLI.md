---
Primary_category: "[[IN-BAND SQLI]]"
title: "UNION BASE SQLI"
draft: true
...
In the *[[#Reading Files|reading files]]* section we have seen how to list all privileges of the current database user
...
> [!BUG]- *Standard Path for Config. Files*
>
> - ***Apache***
>
> ```bash
> /etc/apache2/sites-available/000-default.conf # Debian/Ubuntu
> /etc/httpd/conf.d/welcome.conf # Red Hat/CentOS (ssl.conf)
> ```
>
> - ***Nginx***
>
...
> /etc/nginx/conf.d/default.conf # Red Hat /CentOS
> ```
>
