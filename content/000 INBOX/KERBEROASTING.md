...
> [!DANGER]- *Retrieve all Service Tickets - SetSPN + .NET Class*
> 
> The oneliner below request a *Service Ticket* for each listed *service account* by *setspn.exe* via the `System.IdentityModel.Tokens.KerberosRequestorSecurityToken` *.Net class*
>
> ```bash
...
> ***[Kirbi2john](https://github.com/nidem/kerberoast/blob/master/kirbi2john.py)***

```bash
python2.7 kirbi2john.py <KIRBI_FILE>
```

The above command extracts a *crackable hash format*  for ***[John the Ripper](https://github.com/openwall/john)***

In order to convert the resulting hash in a ***[Hashcat](https://github.com/hashcat/hashcat)*** *crackable hash* proceed as follows
...
> ***[GetUserSPNs.py](https://github.com/fortra/impacket)***
