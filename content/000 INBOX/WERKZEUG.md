...
![[WERKZEUG-20260704175527512.webp|400]]
...
![[WERKZEUG-20260704185031313.webp|300]]
...
As *Werkzeug* is an open-source project, the logic that generates the *PIN* is ***[publicly available](https://github.com/pallets/werkzeug/blob/1b00618e787f40dfb21eba29caf8f8be7c8e1d93/src/werkzeug/debug/__init__.py#L142)***, so if we discover any kind of vulnerability that lead us to a file disclosure, such as an ***[[LFI]]*** or a download feature with a security flaw, it's a game over 💀, we will gain *RCE* as we explained in the section above
...
> [!IMPORTANT]- *Source*
>
> We can infer its name by checking the following resources
>
> ```bash
> /proc/self/cmdline
> /proc/self/environ 
...
>
> ```bash
> flask.app # Flask = Webapp | Werkzeug = Web Server
> wsgi_app # Flask + Werkzeug = Webapp | Gunicorn = Web Server
> app
> application
> main
> ```
...
>
> ```bash
> python3 -c "print(int('00:0c:29:90:75:20'.replace(':',''), 16))"
> ```
>
...
With the generated *PIN*, we should be able to access the *Werkzeug Debug Console* and subsequently run *Python* code as stated ***[[#Debug Mode - Protected Console|here]]***
...
![[WERKZEUG-20260704210911816.webp|400]]
...
***[Ben Grewell: Cracking Flask Werkzeug Console PIN](https://www.bengrewell.com/cracking-flask-werkzeug-console-pin/)***

***[Greg Scharf: LFI to RCE in Flask Werkzeug Application](https://blog.gregscharf.com/2023/04/09/lfi-to-rce-in-flask-werkzeug-application/)***

***[Daehee: Werkzeug Console PIN Exploit](https://www.daehee.com/blog/werkzeug-console-pin-exploit/)***

***[Werkzeug-Debug-Console-Bypass](https://github.com/wdahlenburg/werkzeug-debug-console-bypass)***

***[0xdf: HTB Agile](https://0xdf.gitlab.io/2023/08/05/htb-agile.html)***

***[0xdf: Reassembling Werkzeug's PIN - Part I](https://www.youtube.com/watch?v=6BWaea0nfE0)***

***[0xdf: Reassembling Werkzeug's PIN - Part II](https://www.youtube.com/watch?v=MVItEDBBcgg)***

---

#### *Resources*

***[Hacktricks: Werkzeug](https://hacktricks.wiki/es/network-services-pentesting/pentesting-web/werkzeug.html)***